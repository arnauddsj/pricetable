...
export class InitWithPricetable1723118860272 implements MigrationInterface {
    name = 'InitWithPricetable1723118860272'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "price_table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "general_settings" json NOT NULL, "stripe_public_key" character varying NOT NULL, "paddle_public_key" character varying NOT NULL, "localization_settings" json NOT NULL, "user_id" uuid, CONSTRAINT "PK_063855c405395c4abaf346e7ba0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "is_highlighted" boolean NOT NULL, "highlight_text" character varying NOT NULL, "button_settings" json NOT NULL, "stripe_product_id" character varying NOT NULL, "paddle_product_id" character varying NOT NULL, "price_table_id" uuid, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "feature_group" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "image_url" character varying NOT NULL, "price_table_id" uuid, CONSTRAINT "PK_b2868a3c413f050e6a98b580efc" PRIMARY KEY ("id"))`);
