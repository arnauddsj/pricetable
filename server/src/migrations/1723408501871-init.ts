...
export class Init1723408501871 implements MigrationInterface {
    name = 'Init1723408501871'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "price_table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "general_settings" json NOT NULL, "template_id" uuid, "stripe_public_key" character varying, "paddle_public_key" character varying, "use_localization" boolean NOT NULL DEFAULT false, "user_id" uuid, CONSTRAINT "PK_063855c405395c4abaf346e7ba0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "price" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "unit_amount" numeric(10,2) NOT NULL, "currency" character varying NOT NULL, "billing_cycle" character varying NOT NULL, "checkout_url" character varying, "override_localization" boolean NOT NULL DEFAULT false, "product_id" uuid, CONSTRAINT "PK_d163e55e8cce6908b2e0f27cea4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "country_price" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "country_code" character varying NOT NULL, "unit_amount" numeric(10,2) NOT NULL, "currency" character varying NOT NULL, "price_id" uuid, CONSTRAINT "PK_aef81e93b42994de93118e26f9f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "feature" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "image_url" character varying, "group_id" uuid, CONSTRAINT "PK_03930932f909ca4be8e33d16a2d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "price_table_template" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "styling" jsonb NOT NULL, "is_public" boolean NOT NULL, "original_template_id" uuid, "version" character varying NOT NULL, "custom_css" jsonb NOT NULL, "user_id" uuid, CONSTRAINT "UQ_20652d1b4dbe60a3a28b9cc0634" UNIQUE ("version"), CONSTRAINT "PK_fa522f1b417e7cb95d44ee9f285" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "country_price" ADD CONSTRAINT "FK_094d22fca281bc2a5fb7d707c15" FOREIGN KEY ("price_id") REFERENCES "price"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "country_price" DROP CONSTRAINT "FK_094d22fca281bc2a5fb7d707c15"`);
        ...
        await queryRunner.query(`DROP TABLE "country_price"`);
