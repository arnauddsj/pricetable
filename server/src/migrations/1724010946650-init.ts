...
export class Init1724010946650 implements MigrationInterface {
    name = 'Init1724010946650'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "price_table_template" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "is_public" boolean NOT NULL DEFAULT false, "is_featured" boolean NOT NULL DEFAULT false, "is_premium" boolean NOT NULL DEFAULT false, "version" character varying NOT NULL, "available_feature_icon_url" character varying, "unavailable_feature_icon_url" character varying, "custom_css" jsonb NOT NULL, "original_template_id" uuid, "payment_types" jsonb NOT NULL DEFAULT '[{"name":"Month","type":"cycle","unitName":"/month"}]', "currency_settings" jsonb NOT NULL DEFAULT '{"baseCurrency":"USD","availableCurrencies":["USD"]}', "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_fa522f1b417e7cb95d44ee9f285" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "price_table_draft" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "stripe_public_key" character varying, "paddle_public_key" character varying, "currency_settings" jsonb NOT NULL DEFAULT '{"baseCurrency":"USD","availableCurrencies":["USD"]}', "payment_types" jsonb NOT NULL DEFAULT '[{"name":"Month","type":"cycle","unitName":"/month"}]', "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "price_table_id" uuid, "template_id" uuid, CONSTRAINT "REL_3cc59fa1d0afc07c272fee3ff8" UNIQUE ("price_table_id"), CONSTRAINT "REL_15327076f2d80ee924ec537094" UNIQUE ("template_id"), CONSTRAINT "PK_ed68ae40940715a8a18440363d9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "is_highlighted" boolean NOT NULL, "highlight_text" character varying, "button_text" character varying, "button_link" character varying, "stripe_product_id" character varying, "paddle_product_id" character varying, "price_table_id" uuid, "price_table_draft_id" uuid, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "price_table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "template_id" uuid, "stripe_public_key" character varying, "paddle_public_key" character varying, "currency_settings" jsonb NOT NULL DEFAULT '{"baseCurrency":"USD","availableCurrencies":["USD"]}', "payment_types" jsonb NOT NULL DEFAULT '[{"name":"Month","type":"cycle","unitName":"/month"}]', "is_published" boolean NOT NULL DEFAULT false, "published_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "REL_fa522f1b417e7cb95d44ee9f28" UNIQUE ("template_id"), CONSTRAINT "PK_063855c405395c4abaf346e7ba0" PRIMARY KEY ("id"))`);
