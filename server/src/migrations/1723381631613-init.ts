...
export class Init1723381631613 implements MigrationInterface {
    name = 'Init1723381631613'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "price_table" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "general_settings" json NOT NULL, "stripe_public_key" character varying, "paddle_public_key" character varying, "use_localization" boolean NOT NULL DEFAULT false, "user_id" uuid, CONSTRAINT "PK_063855c405395c4abaf346e7ba0" PRIMARY KEY ("id"))`);
